...
import com.appentus.finecapture.models.EditToolModel;
...
public class EditToolsAdapter extends RecyclerView.Adapter<EditToolsAdapter.ViewHolder> {
    ...
    public EditToolsAdapter(OnToolSelected onToolSelected2) {
        ...
        toolsList.add(new EditToolModel(R.drawable.ic_new_color_filter, EditToolType.COLORFILTER,"Color Filter"));
        toolsList.add(new EditToolModel(R.drawable.ic_new_adjust, EditToolType.ADJUST,"Adjust"));
        toolsList.add(new EditToolModel(R.drawable.ic_new_highlight, EditToolType.HIGHLIGHT,"Highlight"));
        toolsList.add(new EditToolModel(R.drawable.ic_new_picture, EditToolType.PICTURE,"Picture"));
        toolsList.add(new EditToolModel(R.drawable.ic_new_signature, EditToolType.SIGNATURE,"Signature"));
        toolsList.add(new EditToolModel(R.drawable.ic_new_water_mark, EditToolType.WATERMARK,"Watermark"));
        toolsList.add(new EditToolModel(R.drawable.ic_new_text, EditToolType.TEXT,"Text"));
        toolsList.add(new EditToolModel(R.drawable.ic_new_overlay, EditToolType.OVERLAY,"Overlay"));
        toolsList.add(new EditToolModel(R.drawable.ic_new_color_effect, EditToolType.COLOREFFECT,"Color Effect"));
    }
