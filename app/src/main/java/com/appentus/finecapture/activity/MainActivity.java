...
import com.appentus.finecapture.adapter.AllGroupAdapter;
import com.appentus.finecapture.adapter.DrawerItemAdapter;
...
import com.appentus.finecapture.models.DrawerModel;
...
//        et_folder_name = (EditText) findViewById(R.id.et_folder_name);
    ...
    private void bindView() {
        drawerList.add(new DrawerModel("Home", R.drawable.app_logo));
        drawerList.add(new DrawerModel("QR Code Scan", R.drawable.app_logo));
        drawerList.add(new DrawerModel("QR Code Generate", R.drawable.app_logo));
        drawerList.add(new DrawerModel("About Us", R.drawable.app_logo));
        drawerList.add(new DrawerModel("Theme", R.drawable.ic_brightness_blue));
        drawerList.add(new DrawerModel("Terms and Condition", R.drawable.app_logo));
        drawerList.add(new DrawerModel("Privacy Policy", R.drawable.app_logo));
        drawerList.add(new DrawerModel("Share App", R.drawable.app_logo));
        drawerList.add(new DrawerModel("Rate Us", R.drawable.app_logo));
